  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="aspect-[16/9] rounded-xl overflow-hidden mt-8 relative">
              ...
              {relatedFallback.map((p) => (
                <Link key={p.slug} href={`/blog/${p.slug}`} className="group block glass-card rounded-xl overflow-hidden hover:border-brand-300 transition-colors">
                  <div className="aspect-[16/10] overflow-hidden relative">
                    <Image src={p.image} alt={p.title} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 640px) 100vw, 50vw" />
                  </div>
                  <div className="p-4">
